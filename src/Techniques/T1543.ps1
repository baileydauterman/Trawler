...
function Service-Reg-Checks {
    ...
    if (Test-Path -Path "Registry::$path") {
        ...
        foreach ($service in $services) {
            ...
            $service_children_keys = Get-ChildItem -Path "$service_path" -ErrorAction SilentlyContinue | Select-Object Name

            Get-TrawlerItemPropertyProperties $service_path | Where-Object Name -eq "ImagePath" | ForEach-Object {
            ...
            foreach ($child_key in $service_children_keys) {
                ...
                Get-TrawlerItemPropertyProperties $child_path | Where-Object Name -eq "ServiceDll" | ForEach-Object {
